...
##########################################################################
# Verify voltage source calibration table (for range selected above.)

index = 4
timeout = 1.0
i, dac, voltage, timeout = \
	libxsmu.VS_verifyCalibration (deviceID, index, timeout)
print i, dac, voltage

if (timeout == 0.0):
	print 'Communication timeout in VS_verifyCalibration.'
	exit (-2)
